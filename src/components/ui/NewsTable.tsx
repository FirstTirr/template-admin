...
const newsData = [
  {
    ...
    desc: "pada tanggal 21 kalender cahaya, saat pintu cahaya fajar terbuka, seorang wanita yang anggun diangkat menjadi pemimpin keturunan cryshos untuk memimpin perjalanan pencarian benih api pertama",
  ...
  {
    image: "/cerydra3.jpg",
    name: "tahun ke 2 pemerintahan kaisar cerydra di amphoreus",
    desc: "Pada Tanggal 21 kalender cahaya, saat pintu cahaya fajar tertutup, dilakukan lah perayaan 2 tahun pengangkatan kaisar cerydra di kota suci okhema",
  ...
  },
  {
    ...
    desc: "Penacony, 1023 kalender cahaya",
...
export default function NewsTable() {
  ...
  return (
    <div className="bg-white rounded-xl shadow p-6 mt-4">
      ...
      <CreateNews open={showCreate} onClose={() => setShowCreate(false)} />
    </div>
  );
}
